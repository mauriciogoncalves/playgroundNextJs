export default function MainLogo() {
    return (
        <svg viewBox="0 0 56.45161290322581 56.45160830918216" className="main-logo">
            <g transform="translate(-10.311827117810608, -10.311827117810608) scale(0.1505376221578191)" fill="#253b6e" className="main-logo">
...
//https://cdn.logojoy.com/app/editor/goldfoil8.jpg