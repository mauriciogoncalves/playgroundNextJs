export default function TermsOfServices() {
    return (
        <>
            <div className="preview-agreement card-body">
                <div title="English">
                    <div>
                        <div className="row">
                                ...
                                <div><h1>Privacy Policy</h1>
                                    ...
                                    <p>We use Your Personal data to provide and improve the Service. By using the
                                        ...
                                        the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/"
                                               target="_blank" rel="noreferrer">Free Privacy Policy Generator</a>.</p>
                                    ...
                                    <ul>
                                        <li>
                                            <p><strong>Account</strong> means a unique account created for You to access
                                                our Service or parts of our Service.</p>
                                        </li>
                                        <li>
                                            <p><strong>Affiliate</strong> means an entity that controls, is controlled
                                                by or is under common control with a party, where &quote;control&quote; means
                                                ownership of 50% or more of the shares, equity interest or other
                                                securities entitled to vote for election of directors or other managing
                                                authority.</p>
                                        </li>
                                        <li>
                                            <p><strong>Company</strong> (referred to as either &quote;the Company&quote;, &quote;We&quote;, &quote;Us&quote;
                                                or &quote;Our&quote; in this Agreement) refers to mau.servebeer.com.</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <p><strong>Website</strong> refers to mau.servebeer.com, accessible from <a
                                                ...
                                                rel="noreferrer" target="_blank">mau.servebeer.com</a></p>
                                        </li>
                                        <li>
                                    ...
                                    <p>Cookies can be &quote;Persistent&quote; or &quote;Session&quote; Cookies. Persistent Cookies remain on
                                        ...
                                        cookies on the <a
                                            href="//www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking"
                                            rel="noreferrer" target="_blank">Free Privacy Policy website</a> article.</p>
                                    ...
                                    <p>We will let You know via email and/or a prominent notice on Our Service, prior to
                                        the change becoming effective and update the &quote;Last updated&quote; date at the top of
                                    ...
                                    <ul>
                                        <li>By email: mauricio.goncalves@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
